        ...
        <span class="id" >${this.id}</span>
          ...
          <div class="lists-tof-img_dscr">
            ...
            <div type="button" class="lists-tof-img_dscr__like">
                    <span role="button"  tabindex="0" class="like" aria-label="add likes">${this.likes}</span>                 <svg xmlns="http://www.w3.org/2000/svg"       width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
